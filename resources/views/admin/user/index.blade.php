...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row w-25">
                <a href="{{ route('admin.user.create') }}" type="button" class="btn btn-block btn-primary mb-3">Add User</a>
            </div>
            <div class="row">
                <div class="col-6">
                    <div class="card">
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.user.edit', $user->id) }}"><i class="fa fa-pencil text-success" aria-hidden="true"></i></a></td>
                                        <td>
